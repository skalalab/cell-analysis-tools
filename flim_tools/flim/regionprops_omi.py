...
##%%
    ...
    if im_nadh_a1 is not None and \
        im_nadh_a2 is not None and \
        im_nadh_t1 is not None and \
        im_nadh_t2 is not None:
        im_nadh_tau_mean = (im_nadh_a1/100 * im_nadh_t1) + (im_nadh_a2/100 * im_nadh_t2)
    else: im_nadh_tau_mean = None
    
    if im_fad_a1 is not None and \
        im_fad_a2 is not None and \
        im_fad_t1 is not None and \
        im_fad_t2 is not None:    
        im_fad_tau_mean = (im_fad_a1/100 * im_fad_t1) + (im_fad_a2/100 * im_fad_t2)
    else: im_fad_tau_mean = None
    ...
    for rp_key in dict_regionprops.keys():# iterate through each images regionprops
        ...
        for region in dict_regionprops[rp_key]: # iterate through region in regionprops
            ...
            if rp_key in list_valid_intensity_weights: # iterate through valid lifetime images
                pass
