...
def kmeans_threshold(im, k, n_brightest_clusters, show_image=False):
    ...
    num_blanked_dimmer_clusters = (k-n_brightest_clusters) # calculate n_dimm clusters based on clusters to keep
    # get list of clusters, first n are dimmest/smallest
    # https://stackoverflow.com/questions/6910641/how-do-i-get-indices-of-n-maximum-values-in-a-numpy-array
    #https://stackoverflow.com/questions/34226400/find-the-index-of-the-k-smallest-values-of-a-numpy-array
    n_dimmest_clusters = np.argpartition(kmeans.cluster_centers_[:,0], num_blanked_dimmer_clusters)
    indices_smallest = n_dimmest_clusters[:num_blanked_dimmer_clusters] # get a hold of n dimmest clusters
